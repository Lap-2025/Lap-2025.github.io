...
| 2    | P    |                                                                                                                        Kick the tires: Tool installation. OCaml, Jupyter, VSCode + plugin. | [Kick the tires](praticas/en/kick_the_tires.ipynb) / [Exercises](praticas/en/basic.ipynb) |     [Installation guide](praticas/en/install_en.md) |
