...
O Atendimento em horário de dúvidas será feito com marcação prévia por
e-mail nos seguintes locais e usando os respetivos contatos:
...
| 2      | P    |                                                                                                                                                                               | [Kick the tyres: Instalação das ferramentas. OCaml, Jupyter, VSCode + plugin.](praticas/pt/kick_the_tires.ipynb) |           |
