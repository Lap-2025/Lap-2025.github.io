...
| 1      | P    |                                                                                                                                                                               | Não há aulas práticas. No entanto a [instalação das ferramentas](praticas/pt/lab1/install.md) é recomendada.          |           |
...
| 2      | P    |                                                                                                                                                    Kick the tires: Instalação das ferramentas. OCaml, Jupyter, VSCode + plugin. | [Kick the tires](praticas/pt/lab1/kick_the_tires.ipynb) / [Exercícios](praticas/pt/lab1/basic.ipynb) |     [Instruções de instalação](praticas/pt/lab1/install.md)    |
